...
def to_odt(self):
	import inspect
	dirname = os.path.dirname(inspect.getframeinfo(inspect.currentframe()).filename)
	opts = AttrDict(base_doc=os.path.join(dirname, 'asciidoc.ott'), temp_dir=None) # TODO remove hardcoded dir
